...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const sheet = spreadsheet.data.sheets.find(s => s.properties.title === 'Announcements Board');
        ...
        const startIndex = rowIndex + 1; // 0-based, +1 for header row
        ...
        return { statusCode: 500, body: JSON.stringify({ error: 'Failed to delete announcement' }) };
    }
};
